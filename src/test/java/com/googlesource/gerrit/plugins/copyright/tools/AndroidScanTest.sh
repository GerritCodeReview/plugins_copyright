...
readonly scanner="${TEST_SRCDIR}/google3/java/com/google/devtools/compliance/copyright/android_scan"
readonly testdata="${TEST_SRCDIR}/google3/javatests/com/google/devtools/compliance/copyright/testdata"
