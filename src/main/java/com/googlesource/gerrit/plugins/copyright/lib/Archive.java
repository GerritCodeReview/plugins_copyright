...
public abstract class Archive {
  ...
  public abstract ArchiveInputStream newStream(BufferedInputStream source)
  ...
  private static final class ArFile extends Archive {
    ...
    @Override
    public ArchiveInputStream newStream(BufferedInputStream source)
        throws ArchiveException {
      return new ArArchiveInputStream(source);
    }

    @Override
    public ArchiveEntry getNext(ArchiveInputStream archive)
        throws ArchiveException, IOException {
